...
public abstract class AdvancedEnchantment extends GenericEnchantment {
    ...
    public static final AdvancedEnchantment EMPATHY_CURSE = new EmpathyCurse();
    public static final AdvancedEnchantment ENDER_CURSE = new EnderCurse();
    public static final AdvancedEnchantment FRAGILITY_CURSE = new FragilityCurse();
    ...
    public static final AdvancedEnchantment MISFORTUNE_CURSE = new MisfortuneCurse();
    public static final AdvancedEnchantment NIGHT_CURSE = new NightCurse();
    public static final AdvancedEnchantment PACIFISM_CURSE = new PacifismCurse();
    public static final AdvancedEnchantment SILENCE_CURSE = new SilenceCurse();
    ...
    public static final AdvancedEnchantment VOID_CURSE = new VoidCurse();
